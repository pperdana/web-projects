...
function App() {
  ...
  return (
    <main className="h-screen	flex flex-col	items-center	justify-center">
      <section className="advice-container bg-[hsl(217,19%,24%)] w-[550px] text-center	py-[48px] px-[32px] rounded-[12px] relative md:w-auto md:my-0 md:mx-[20px]">
        <h1 className="advice-title uppercase text-[12px] text-[hsl(150,100%,66%)] tracking-[4px] mb-[24px]">
          advice #{adviceId}
        </h1>

        <p className="advice-text font-extrabold	leading-[1.3] mb-[2rem] md:text-[22.5px]">
          &quot;{advice}&quot;
        </p>
        <div className="divider mb-[14px] text-center">
          <div className="divider-icon bg-[url('./images/pattern-divider-desktop.svg')] bg-contain	bg-no-repeat	h-[20px] sm:bg-[url('./images/pattern-divider-mobile.svg')]" />
        </div>
